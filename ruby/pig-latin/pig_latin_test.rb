...
class PigLatinTest < Minitest::Test
  ...
  def test_diphtong_1
    assert_equal true, PigLatin.new('equal').diphthong?
  end

  def test_starts_with_vowel_1
    assert_equal true, PigLatin.new('equal').starts_with_vowel?
  end
  ...
  def test_rule4_1
    assert_equal false, PigLatin.new('therapy').rule4?
  end
  ...
  def test_starts_with_vowel_2
    # skip
    assert_equal false, PigLatin.new('rhythm').starts_with_vowel?
  end

  def test_diphtong_2
    # skip
    assert_equal false, PigLatin.new('rhythm').diphthong?
  end

  def test_rule4_2
    assert_equal true, PigLatin.new('rhythm').rule4?
  end
